...
HD_PWD='D:/THOR/Abhishek_git/programmable_sequence_detector/programmable_sequence_detector.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log programmable_sequence_detector.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source programmable_sequence_detector.tcl
